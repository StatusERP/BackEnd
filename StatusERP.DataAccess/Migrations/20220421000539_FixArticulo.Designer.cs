...
namespace StatusERP.DataAccess.Migrations
{
    ...
    [Migration("20220421000539_FixArticulo")]
    partial class FixArticulo
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("StatusERP.Entities.CI.Tablas.Articulo", b =>
                {
                    ...
                    b.Property<int>("ClasifInv1Id")
                        .HasColumnType("int");

                    b.Property<int>("ClasifInv2Id")
                        .HasColumnType("int");

                    b.Property<int>("ClasifInv3Id")
                        .HasColumnType("int");

                    b.Property<int>("ClasifInv4Id")
                        .HasColumnType("int");

                    b.Property<int>("ClasifInv5Id")
                        .HasColumnType("int");

                    b.Property<int>("ClasifInv6Id")
                        .HasColumnType("int");

                    b.Property<int?>("Clasificacion1")
                        .HasColumnType("int");

                    b.Property<int?>("Clasificacion2")
                        .HasColumnType("int");

                    b.Property<int?>("Clasificacion3")
                        .HasColumnType("int");

                    b.Property<int?>("Clasificacion4")
                        .HasColumnType("int");

                    b.Property<int?>("Clasificacion5")
                        .HasColumnType("int");

                    b.Property<int?>("Clasificacion6")
                        .HasColumnType("int");
                    ...
                    b.Property<int>("UnidadAlmacen")
                        .HasColumnType("int");

                    b.Property<int>("UnidadAlmacenFKId")
                        .HasColumnType("int");

                    b.Property<int>("UnidadEmpaque")
                        .HasColumnType("int");

                    b.Property<int>("UnidadEmpaqueFKId")
                        .HasColumnType("int");

                    b.Property<int>("UnidadVenta")
                        .HasColumnType("int");

                    b.Property<int>("UnidadVentaFKId")
                        .HasColumnType("int");
                    ...
                    b.HasIndex("ClasifInv1Id");

                    b.HasIndex("ClasifInv2Id");

                    b.HasIndex("ClasifInv3Id");

                    b.HasIndex("ClasifInv4Id");

                    b.HasIndex("ClasifInv5Id");

                    b.HasIndex("ClasifInv6Id");

                    b.HasIndex("ImpuestoFKId");

                    b.HasIndex("UnidadAlmacenFKId");

                    b.HasIndex("UnidadEmpaqueFKId");

                    b.HasIndex("UnidadVentaFKId");
            ...
            modelBuilder.Entity("StatusERP.Entities.CI.Tablas.Articulo", b =>
                {
                    b.HasOne("StatusERP.Entities.CI.Tablas.ClasificacionInv", "ClasifInv1")
                        .WithMany()
                        .HasForeignKey("ClasifInv1Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.CI.Tablas.ClasificacionInv", "ClasifInv2")
                        .WithMany()
                        .HasForeignKey("ClasifInv2Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.CI.Tablas.ClasificacionInv", "ClasifInv3")
                        .WithMany()
                        .HasForeignKey("ClasifInv3Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.CI.Tablas.ClasificacionInv", "ClasifInv4")
                        .WithMany()
                        .HasForeignKey("ClasifInv4Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.CI.Tablas.ClasificacionInv", "ClasifInv5")
                        .WithMany()
                        .HasForeignKey("ClasifInv5Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.CI.Tablas.ClasificacionInv", "ClasifInv6")
                        .WithMany()
                        .HasForeignKey("ClasifInv6Id")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.AS.Tablas.Impuesto", "ImpuestoFK")
                        .WithMany()
                        .HasForeignKey("ImpuestoFKId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.AS.Tablas.UnidadMedida", "UnidadAlmacenFK")
                        .WithMany()
                        .HasForeignKey("UnidadAlmacenFKId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.AS.Tablas.UnidadMedida", "UnidadEmpaqueFK")
                        .WithMany()
                        .HasForeignKey("UnidadEmpaqueFKId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("StatusERP.Entities.AS.Tablas.UnidadMedida", "UnidadVentaFK")
                        .WithMany()
                        .HasForeignKey("UnidadVentaFKId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.Navigation("ClasifInv1");

                    b.Navigation("ClasifInv2");

                    b.Navigation("ClasifInv3");

                    b.Navigation("ClasifInv4");

                    b.Navigation("ClasifInv5");

                    b.Navigation("ClasifInv6");

                    b.Navigation("ImpuestoFK");

                    b.Navigation("UnidadAlmacenFK");

                    b.Navigation("UnidadEmpaqueFK");

                    b.Navigation("UnidadVentaFK");
                });
